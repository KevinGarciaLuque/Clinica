-- ============================================================
--  MULTI-CLÍNICA — Schema completo v1.0
--  Motor: MySQL 8+
--  Arquitectura: multi-tenant shared-schema (clinica_id en cada tabla)
--  Módulos cubiertos: 1 a 11 + IA + Facturación + Comunicación
-- ============================================================
...
-- ============================================================
-- MÓDULO 1 — CLÍNICAS Y CONFIGURACIÓN
-- ============================================================
...
-- Configuración flexible por clínica (pares clave-valor)
...
-- ============================================================
-- MÓDULO 1 — USUARIOS (médicos, enfermeras, recepcionistas, admins)
-- ============================================================
...
-- Catálogo de servicios y precios por clínica
...
-- Plantillas de documentos (logo + header/footer configurables)
...
-- CIE-10 simplificado (puedes importar el catálogo completo después)
...
CREATE TABLE IF NOT EXISTS prescripciones (
  ...
  pdf_url         VARCHAR(300),
  firma_digital_url VARCHAR(500) COMMENT 'Firma digital usada al generar la receta',
...
CREATE TABLE IF NOT EXISTS estudios_solicitudes (
  ...
  firma_digital_url VARCHAR(500) COMMENT 'Firma digital usada al generar la solicitud',
...
-- ============================================================
-- MÓDULO 7 — VISUALIZADOR DE IMÁGENES (metadatos)
-- ============================================================
...
-- ============================================================
-- MÓDULO 9 — COMUNICACIÓN / MENSAJERÍA INTERNA
-- ============================================================
...
-- ============================================================
-- MÓDULO IA — Historial de conversaciones del asistente
-- ============================================================

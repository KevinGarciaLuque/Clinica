...
router.post("/historia/:paciente_id", auth(...ROLES_ESCRITURA), async (req, res) => {
  try {
    ...
    const {
      ...
      autoanticuerpos, tratamiento_inicial, antecedentes_patologicos, antecedentes_otros,
    ...
    await pool.query(`
      ...
      ON DUPLICATE KEY UPDATE
        ...
        circunstancia_diagnostico=VALUES(circunstancia_diagnostico), circunstancia_otro=VALUES(circunstancia_otro),
        autoanticuerpos=VALUES(autoanticuerpos), tratamiento_inicial=VALUES(tratamiento_inicial),
        antecedentes_patologicos=VALUES(antecedentes_patologicos), antecedentes_otros=VALUES(antecedentes_otros),
    ...
    `, [
      cid, pid, medico || null,
      fecha_diagnostico || null, edad_diagnostico || null, circunstancia_diagnostico || null, circunstancia_otro || null,
      jsonOrNull(autoanticuerpos), jsonOrNull(tratamiento_inicial),
      jsonOrNull(antecedentes_patologicos), antecedentes_otros || null,
  ...
  try {
    ...
    const [result] = await pool.query(`
      INSERT INTO seguimientos_endocrinologia
        (clinica_id, paciente_id, medico_id, fecha,

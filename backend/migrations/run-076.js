/**
 * run-076.js — Facturación de licencias (contrato + recibos mensuales)
 * Ejecutar: node migrations/run-076.js
 */
...
async function run() {
  ...
  console.log("\n🚀 Migración 076 — facturación de licencias...\n");
  const sqlFile = fs.readFileSync(path.join(__dirname, "076_indices_escala_clinicas.sql"), "utf8");

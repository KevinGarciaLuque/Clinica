/**
 * run-066.js — Flag `titulo_medico` por clínica (mostrar u ocultar "Dr./Dra." + especialidad)
 * Ejecuta cada sentencia por separado y tolera errores de "ya existe".
 * Ejecutar: node migrations/run-066.js
 */
...
async function run() {
  ...
  console.log("\n🚀 Iniciando migración 066 — flag titulo_medico por clínica...\n");

  const sqlFile = fs.readFileSync(
    path.join(__dirname, "066_titulo_medico_clinica.sql"),
    "utf8"
  );

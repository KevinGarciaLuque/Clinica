/**
 * run-075.js — Facturación de licencias (contrato + recibos mensuales)
 * Ejecutar: node migrations/run-075.js
 */
...
async function run() {
  ...
  console.log("\n🚀 Migración 075 — facturación de licencias...\n");
  const sqlFile = fs.readFileSync(path.join(__dirname, "075_solicitud_plan_lead.sql"), "utf8");

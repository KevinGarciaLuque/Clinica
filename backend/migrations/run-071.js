/**
 * run-071.js — Tabla marketing_medico_items + claves de config de la sección Marketing Médico
 * Ejecutar: node migrations/run-071.js
 */
...
async function run() {
  ...
  console.log("\n🚀 Migración 071 — marketing_medico...\n");
  const sqlFile = fs.readFileSync(path.join(__dirname, "071_marketing_medico.sql"), "utf8");

/**
 * run-058.js — Módulo Exportar Pacientes
 * Ejecuta cada sentencia por separado y tolera errores de "ya existe".
 * Ejecutar: node migrations/run-058.js
 */
...
async function run() {
  ...
  console.log("\n🚀 Iniciando migración 058 — Módulo Exportar Pacientes...\n");

  const sqlFile = fs.readFileSync(
    path.join(__dirname, "058_modulo_exportar_pacientes.sql"),
    "utf8"
  );

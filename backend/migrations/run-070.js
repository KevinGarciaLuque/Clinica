/**
 * run-070.js — Tabla informes_mcg (Informe de Monitoreo Continuo de Glucosa)
 * Ejecutar: node migrations/run-070.js
 */
...
async function run() {
  ...
  console.log("\n🚀 Migración 070 — informes_mcg...\n");
  const sqlFile = fs.readFileSync(path.join(__dirname, "070_informes_mcg.sql"), "utf8");

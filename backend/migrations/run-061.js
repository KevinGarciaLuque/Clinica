/**
 * run-061.js — Módulo "consulta" para especialidades nuevas (26-33)
 * Ejecuta cada sentencia por separado y tolera errores de "ya existe".
 * Ejecutar: node migrations/run-061.js
 */
...
async function run() {
  ...
  console.log("\n🚀 Iniciando migración 061 — Módulo consulta en especialidades nuevas...\n");

  const sqlFile = fs.readFileSync(
    path.join(__dirname, "061_consulta_especialidades_nuevas.sql"),
    "utf8"
  );

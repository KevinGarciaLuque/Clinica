/**
 * run-064.js — cita_id en estudios_solicitudes
 * Ejecuta cada sentencia por separado y tolera errores de "ya existe".
 * Ejecutar: node migrations/run-064.js
 */
...
async function run() {
  ...
  console.log("\n🚀 Iniciando migración 064 — cita_id en estudios_solicitudes...\n");

  const sqlFile = fs.readFileSync(
    path.join(__dirname, "064_estudios_cita_id.sql"),
    "utf8"
  );

/**
 * run-065.js — módulos admin fijos (usuarios, horarios, servicios, plantillas,
 * documentos clínicos, catálogos, configuración) al sistema de permisos.
 * Ejecuta cada sentencia por separado y tolera errores de "ya existe".
 * Ejecutar: node migrations/run-065.js
 */
...
async function run() {
  ...
  console.log("\n🚀 Iniciando migración 065 — módulos admin fijos...\n");

  const sqlFile = fs.readFileSync(
    path.join(__dirname, "065_modulos_admin_items.sql"),
    "utf8"
  );

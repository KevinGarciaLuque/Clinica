/**
 * run-068.js — Columna clinicas.bloqueada (candado de protección, solo SUPER_ADMIN)
 * Ejecutar: node migrations/run-068.js
 */
...
async function run() {
  ...
  console.log("\n🚀 Migración 068 — clinicas.bloqueada...\n");
  const sqlFile = fs.readFileSync(path.join(__dirname, "068_clinica_bloqueada.sql"), "utf8");

/**
 * run-060.js — Cola de envío a recepción para recetas y estudios
 * Ejecuta cada sentencia por separado y tolera errores de "ya existe".
 * Ejecutar: node migrations/run-060.js
 */
...
async function run() {
  ...
  console.log("\n🚀 Iniciando migración 060 — Cola de envío a recepción...\n");

  const sqlFile = fs.readFileSync(
    path.join(__dirname, "060_recepcion_envio.sql"),
    "utf8"
  );

...
export default function OlvideContrasena() {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      setMsg(err?.response?.data?.msg || "No se pudo procesar la solicitud. Intenta de nuevo.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <>
      <style>{`
        ...
        .glass-card .input-group-text {
          background: rgba(255,255,255,0.12); border: 1px solid rgba(255,255,255,0.25); color: rgba(255,255,255,0.7);
        }
        .btn-glass-primary {
      ...
      <div className="login-bg">
        ...
        <div className="glass-card">
          <div className="text-center mb-4">
            ...
            <h4 className="fw-bold mb-1">¿Olvidaste tu contraseña?</h4>

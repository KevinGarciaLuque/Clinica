    ...
    <div className="container-fluid py-3">
      <div className="d-flex align-items-center justify-content-between mb-3">
        <h4 className="mb-0 fw-bold">
          <i className="bi bi-shield-plus me-2 text-primary" />
      ...
      {paciente ? (
        ...
        <div className="text-center text-muted py-5">
          <i className="bi bi-shield-plus fs-1 d-block mb-2 opacity-25" />
          <p className="mb-0">Busca y selecciona un paciente para ver su carnet de vacunación.</p>
        </div>
      )}
    </div>
  );

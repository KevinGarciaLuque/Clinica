  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: bio ? 0 : 28 }}>
          {redes.map(r => (
            <a
              key={r.key}
              ...
              style={{
                ...
                borderRadius: 16, padding: "14px 20px", fontWeight: 700, fontSize: 15,
          ...
          {whatsapp && (
            <a
              ...
              style={{
                ...
                borderRadius: 16, padding: "14px 20px", fontWeight: 800, fontSize: 15,
                marginTop: 8,
        ...
        <p style={{ color: "rgba(255,255,255,0.35)", fontSize: 12, marginTop: 30, marginBottom: 0 }}>
